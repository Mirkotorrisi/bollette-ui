...
export const CreditsComponent = () => {
  return (
    <section className="credits_component">
      ...
      <div className="tickets_container">
        <div className="tech_cont">
          ...
          <div className="credits_card">
            ...
            <p>
              A well-structured API which provides any kind of sport odds
              updated in real time. Try it by clicking
      ...
      <div className="tickets_container">
        <div className="tech_cont">
          ...
          <div className="react credits_card ">
            ...
            <p>
              An open-source JavaScript library for building user interfaces or
              UI components. It is maintained by Facebook and a community of
      ...
      <div className="tickets_container">
        <div className="tech_cont">
          ...
          <div className="credits_card">
            ...
            <p>
              The standard technologies designed for building web applications
              and APIs with JavaScript.
            </p>
          </div>
        </div>
        <div className="tech_cont">
        ...
        <div className="tech_cont">
          ...
          <div className=" mysql credits_card">
            ...
            <p>
              An open source, in-memory data structure store, used as a
        ...
        <div className="tech_cont">
          ...
          <div className=" python credits_card">
            ...
            <p>
              An interpreted, high-level and general-purpose programming
              language. I used its library BeautifulSoup to scrape livescore.cz
            </p>
          </div>
        </div>
      </div>
      <div className="tech_cont">
        <h1 className="white">
          Take a look at source code: <a href="https://github.com/Mirkotorrisi/bollette-ui">React App (UI)</a> -
          <a href="https://github.com/Mirkotorrisi/bollette-server">Express Server</a>
